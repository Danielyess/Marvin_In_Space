#Should be used with things THAT CAN BE INTERACTED WITH or with the collectables
#For now the player can interact with Levers, end-of-level-doors and switchboxes
